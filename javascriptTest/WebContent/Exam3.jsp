...
<script type="text/javascript">
	...
	function outputFnc(divLength, spanNum) {
...
// 		var spanLength = divLength * 2;
		...
		var spanLength = divLength * spanNum;
		...
		for (var i = 0; i < spanLength; i++) {
			spanObjList[i].innerHTML = (parseInt(i/spanNum) + 1);
// 			spanObjList[i].innerHTML = (parseInt(i/2) + 1);
		}
		
		for (var i = 0; i < spanLength; i++) {
			divObjList[parseInt(i/spanNum)].appendChild(spanObjList[i]);
